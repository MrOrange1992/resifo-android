...
class BirthplaceActivity extends AppCompatActivity
{
  override protected def onCreate(savedInstanceState: Bundle)
  {
    super.onCreate(savedInstanceState)
    setContentView(R.layout.activity_birthplace)
  }
  ...
  def gotoMaritalstatusActivity(view: View): Unit = startActivity(new Intent(this, classOf[MaritalstatusActivity]))
